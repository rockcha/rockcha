...
Recently, I’ve been developing web applications and tools that integrate real user workflows, including authentication, data-driven UI, and interactive components. I’m especially interested in how design, usability, and logic come together to create a polished product.

Moving forward, I aim to grow as a front-end developer with a strong understanding of modern web architecture, performance optimization, and maintainable code. I’m also interested in collaborating on meaningful products and continuously improving through real-world projects.
...
최근에는 인증, 데이터 기반 UI, 인터랙티브한 컴포넌트를 포함한 웹 애플리케이션 및 도구를 개발하고 있으며, 단순한 기능 구현을 넘어 UX와 디자인, 로직이 자연스럽게 연결되는 완성도 있는 서비스를 만드는 데 관심이 많습니다.

앞으로는 모던 웹 아키텍처에 대한 이해를 바탕으로 유지보수성과 성능을 고려할 수 있는 프론트엔드 개발자로 성장하고 싶으며, 실무에 가까운 프로젝트와 협업을 통해 꾸준히 발전해 나가고자 합니다.
